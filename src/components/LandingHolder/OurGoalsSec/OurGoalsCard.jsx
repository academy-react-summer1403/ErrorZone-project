...
const OurGoalsCard = ({title, description, image}) => {
  ...
  return (
    <div className="card  border-2 border-gray-400 hover:border-blue hover:cursor-pointer text-right rounded-3xl p-5 w-full desktop:w-1/5 mobile:w-1/3 h-[442px] bg-white dark:bg-black" >
