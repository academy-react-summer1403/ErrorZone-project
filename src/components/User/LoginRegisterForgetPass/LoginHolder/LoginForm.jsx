   ...
   <>
    <div className='  w-[100%] h-[87%] mt-[105px]' dir='rtl'>
      <div className='flex gap-[20px] '>      
           ...
           <p className='w-[200px] h-[40px] relative top-[100px] right-[60px] font-semibold text-3xl text-black font-DanaFaNum-600 dark:text-white '>   خوش برگشتی  !</p> 
           <p className='w-[346px] h-[46px] relative top-[115px] right-[60px] font-DanaFaNum-600 text-gray-500'>    لطفا شماره تلفن همراه یا ایمیل و رمز عبور خود را برای وارد به حساب کاربری وارد نمایید </p>
          <div>    
        <Formik 
        ...
        >
          <Form>
            <div className='flex flex-wrap w-[600px] h-auto relative top-[160px]  text-black '>
               <AuthFields type='text' name='phoneOrGmail' placeholder='شماره خود را وارد کنید' label='شماره همراه یا ایمیل'/>            
               <AuthFields  type='password' name='password' placeholder='رمز عبور خود را وارد کنید' label='رمز عبور' icon={ <ViewIcon size={24} />}/>
                <ViewIcon className='relative right-[420px] bottom-[60px]' />
               <div className=' w-[66%] relative  right-[70px] flex justify-between '> 
                <BlueCheckBox type='checkbox' name='rememberMe' labelName='مرا به خاطر بسپار' />
                 <div className='w-[175px] h-[36px] relative left-[34px]  bg-gray-100 flex justify-center items-center rounded-[40px] text-sm font-DanaFaNum-600 mt-[10px]'>
                   <Link className='text-sky-400  '>   رمز عبور را فراموش کرده اید؟  </Link>
                 </div> 
               </div> 
             ...
             <ButtonSpecial type='submit' innerHtml='ورود به حساب ' className=' text-white w-[98px] h-[23px] font-DanaFaNum-600 text-base '
              isDisabled={isDisabled} />
                ...
                <div className='bg-white w-[283px] h-[30px] relative top-[40px] right-[120px] flex gap-2'> 
                  ...
                  <Link className='border-b-sky-500 w-[125px] h-[23px] text-blue font-DanaFaNum-600 text-base border-b border-sky-400'>  ایجاد حساب کاربری </Link>
               </div>
               <div className='bg-white w-[141px] h-[40px] rounded-[34px] border-2 border-gray-400  relative top-[85px] left-[90px] flex justify-center items-center'>
                  <Link className='w-[77px] h-[23px] font-DanaFaNum-500 text-blue text-base' >    صفحه اصلی  </Link>
          ...
          <Link className='w-32 h-32 bg-red' to='/login/verifycode'>  next page    </Link>             
 </>      
  )
}
